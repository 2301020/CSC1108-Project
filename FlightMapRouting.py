...
#     # Define the relative path to the file within the Data folder
    ...
    return FlightPathing(airports_location, routes_location)
...
def main():
    ...
    print(flight_pathing.getAlternativePath("Tobago-Crown Point Airport",  "Marau Airport", searchParameter))
